...
class NavigationControl {
    ...
    constructor(options: Options) {
        ...
        if (this.options.showZoom) {
            ...
            this._zoomInButton = this._createButton('mapboxgl-ctrl-zoom-in', (e) => this._map.zoomIn({}, {
                originalEvent: e
            }));
            DOM.create('span', `mapboxgl-ctrl-icon`, this._zoomInButton).setAttribute('aria-hidden', true);
            this._zoomOutButton = this._createButton('mapboxgl-ctrl-zoom-out', (e) => this._map.zoomOut({}, {
                originalEvent: e
            }));
