...
export class Placement {
    ...
    placements: {
        [_: CrossTileID]: JointPlacement
    };
    opacities: {
        [_: CrossTileID]: JointOpacityState
    };
    variableOffsets: {
        [_: CrossTileID]: VariableOffset
    };
    placedOrientations: {
        [_: CrossTileID]: number
    };
    commitTime: number;
    ...
    attemptAnchorPlacement(anchor: TextAnchor, textBox: SingleCollisionBox, width: number, height: number,
        ...
        textAllowOverlap: boolean, symbolInstance: SymbolInstance, bucket: SymbolBucket, orientation: number, iconBox: ? SingleCollisionBox): ? {
        shift: Point,
        placedGlyphBoxes: {
            box: Array < number > ,
            offscreen: boolean
    ...
    placeLayerBucketPart(bucketPart: Object, seenCrossTileIDs: {
